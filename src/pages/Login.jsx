      ...
      <div className="w-full max-w-md p-8 rounded-xl shadow-lg bg-od-ivory/90 backdrop-blur-lg border border-od-gold">
        ...
        >
          ...
          <svg className="w-6 h-6 mr-2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g>
              <path d="M12 2C6.477 2 2 6.477 2 12c0 5.523 4.477 10 10 10 5.523 0 10-4.477 10-10 0-.68-.07-1.342-.2-1.98H12v4h5.588c-.241 1.285-1.445 3.777-5.588 3.777-2.363 0-4.363-1.777-5.104-4.177l-3.273 2.404c1.652 1.5 4.026 2.55 6.653 2.55 3.363 0 6.104-2.777 6.104-6.2 0-.627-.07-1.242-.195-1.828z" fill="#4285F4"/>
              <path d="M3.272 6.545l3.273 2.404c.889-1.2 2.241-2.049 3.955-2.049 1.921 0 3.211.818 3.953 1.51l2.7-2.7C15.256 3.923 13.74 3 12 3c-2.627 0-5.001 1.05-6.653 2.55z" fill="#34A853"/>
              ...
              <path d="M10.04 4.9c1.921 0 3.211.818 3.953 1.51l2.7-2.7C15.256 3.923 13.74 3 12 3c-2.627 0-5.001 1.05-6.653 2.55l3.273 2.404c.889-1.2 2.241-2.049 3.955-2.049z" fill="#EA4335"/>
            </g>
          </svg>
